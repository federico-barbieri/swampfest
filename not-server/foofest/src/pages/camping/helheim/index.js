...
import helheimImg from "../../../public/imgs/campImgs/helheim.jpg";
      ...
      <div className={law.contentAndBasket}>
        <div className={law.content}>
          ...
          <div className={law.campInfo}>
            <ThirdTitle thirdTitle="HELHEIM" />

            <p className={law.description}>
              Immerse yourself in the vibrant spirit of Helheim. Our most
              dynamic campsite, it's located right in the heart of the festival.
              Here, you'll be at the epicenter of the energy and excitement,
              with non-stop music, thrilling performances, and the lively bustle
              of festival life.
            </p>
          </div>
