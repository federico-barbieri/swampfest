...
import muspelheimImg from "../../../public/imgs/campImgs/muspelheim.jpg";
      ...
      <div className={law.contentAndBasket}>
        <div className={law.content}>
          ...
          <div className={law.campInfo}>
            <ThirdTitle thirdTitle="MUSPELHEIM" />

            <p className={law.description}>
              Welcome to Muspelheim, where the fire of the festival burns
              brightest. This sun-kissed site is perfect for those who love to
              bask in the warmth of the day and dance under the fiery hues of
              the sunset.
            </p>
          </div>
