...
import nilfheimImg from "../../../public/imgs/campImgs/nilfheim.jpg";
      ...
      <div className={law.contentAndBasket}>
        <div className={law.content}>
          ...
          <div className={law.campInfo}>
            <ThirdTitle thirdTitle="NILFHEIM" />
            <p className={law.description}>
              Enter Nilfheim, where serenity meets excitement. This serene
              camping area is nestled by a sparkling river, offering a
              refreshing retreat from the festival's energetic pulse.
            </p>
          </div>
